...
def sample_search_results():
    ...
    return SearchResults(
        ...
        metadata=[
            ...
            {"course_title": "MCP: Build Rich-Context AI Apps with Anthropic", "lesson_number": 4},
            {"course_title": "MCP: Build Rich-Context AI Apps with Anthropic", "lesson_number": 5}
        ],
...
def sample_course_outline():
    ...
    return {
        ...
        "num_lessons": 3,
        "lessons": [
            {"lesson_number": 1, "title": "Why MCP", "lesson_link": "https://example.com/lesson1"},
            {"lesson_number": 4, "title": "Creating An MCP Server", "lesson_link": "https://example.com/lesson4"},
            {"lesson_number": 5, "title": "Creating An MCP Client", "lesson_link": "https://example.com/lesson5"}
        ]
    }
